...
Yes, you can switch AI models without starting a new conversation. In Capriole AI, the selected model can change from one turn to the next while the thread stays in the same workspace.
