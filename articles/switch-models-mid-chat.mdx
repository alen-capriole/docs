...
Yes, you can switch AI models without starting a new conversation. In Capriole AI, the selected model can change from one turn to the next while the thread stays in the same workspace. Signed-out visitors and Free users can try GPT-5.6 Thinking, Claude Fable 5.1, and Gemini 3.1 Pro before upgrading.
