...
The focused public-route and file-conversion suites completed **68 automated tests** against controlled upstream responses, not production live calls. Separate local upstream and coding-agent runs check behavior that a mocked endpoint cannot prove.
