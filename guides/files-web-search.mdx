...
The same workspace can continue the task with GPT-5.6 Thinking, Claude Fable 5.1, or Gemini 3.1 Pro without copying the material into separate products. Premium costs USD 8 per month and makes browser chat unlimited across the supported Premium model set.
