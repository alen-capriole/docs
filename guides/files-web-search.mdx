...
description: "Generate images with GPT Image 2 for free, upload files, and use web search in Browser Chat. Learn the sign-in and Server Storage requirements."
---
...
2. Open the model selector, choose the **Image** tab, and select **GPT Image 2**. Describe the image you want.
