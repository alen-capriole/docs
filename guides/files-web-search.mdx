...
For the model's official release details, see [OpenAI's changelog](https://developers.openai.com/api/docs/changelog). The features available in Capriole AI are described above.
