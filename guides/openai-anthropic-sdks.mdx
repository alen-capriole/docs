...
[Try GPT-6 Astra, Claude Fable 5.1, or Gemini 3.1 Pro in limited free browser chat](https://capriole.ai), then upgrade to Premium when you want to use the included API balance from Python or TypeScript.
