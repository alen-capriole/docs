...
You need an active Premium membership, a [Capriole AI API key](https://capriole.ai?view=api), and either Python or Node.js 20 or later. Copy a newly created key when Capriole shows it; the full secret is not shown again.
