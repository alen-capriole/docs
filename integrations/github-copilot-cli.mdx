...
- Chat Completions: `openai-latest`, `openai/gpt-5.5`, `openai/gpt-5.4-mini`, `claude-latest`, `anthropic/claude-opus-4-8`, `anthropic/claude-opus-4-7`, `google-latest`, `google/gemini-3.1-pro-preview`, and `google/gemini-3.5-flash`
- Responses: `openai-latest`, `openai/gpt-5.5`, and `openai/gpt-5.4-mini`
- Anthropic Messages: `claude-latest`, `claude-opus-4-8`, and `claude-opus-4-7`
