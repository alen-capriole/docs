...
OpenClaw supports OpenAI latest, GPT 5.5, GPT 5.4 mini, Claude latest, Opus 4.8, and Opus 4.7 through Capriole AI. Use `openai-latest` and `claude-latest` for new setups.
...
Run `openclaw models list`, then confirm the selected model and any `agents.defaults.models` allowlist include the Capriole AI model reference, such as `capriole-ai-openai/openai-latest`, `capriole-ai-openai/openai/gpt-5.5`, `capriole-ai-anthropic/claude-latest`, or `capriole-ai-anthropic/claude-opus-4-8`.
