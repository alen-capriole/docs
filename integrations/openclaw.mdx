...
OpenClaw supports GPT 5.5, Opus 4.8, and Opus 4.7 through Capriole AI. Use Opus 4.8 for new setups.
...
Run `openclaw models list`, then confirm the selected model and any `agents.defaults.models` allowlist include `capriole-ai-openai/openai/gpt-5.5` or `capriole-ai-anthropic/claude-opus-4-8`.
