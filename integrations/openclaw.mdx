...
Run `openclaw models list`, then confirm the selected model and any `agents.defaults.models` allowlist include `capriole-ai-openai/openai/gpt-5.5` or `capriole-ai-anthropic/claude-opus-4-7`.
