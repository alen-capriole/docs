...
Use `/models` to select OpenAI latest, GPT 5.5, GPT 5.4 mini, Claude latest, Opus 4.8, or Opus 4.7. Use `Ctrl+T` to cycle model variants.

## Supported models

OpenCode supports OpenAI latest, GPT 5.5, GPT 5.4 mini, Claude latest, Opus 4.8, and Opus 4.7 through Capriole AI. Use `openai-latest` and `claude-latest` for new setups.
