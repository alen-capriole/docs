...
Claude Code supports Claude latest, Opus 4.8, and Opus 4.7 through Capriole AI. Use `claude-latest` for new setups so Capriole AI can route Claude Code to our recommended flagship Claude model without changing your config.
