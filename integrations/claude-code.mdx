...
Claude Code supports Claude latest, Fable 5.1, Fable 5, Opus 5, Opus 4.8, Opus 4.7, Opus 4.6, and Sonnet 4.6 through Capriole AI. Use `claude-latest` for new setups; it resolves to Fable 5.1.
