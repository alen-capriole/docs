...
Codex supports Capriole AI OpenAI models through the Responses API. Use GPT 5.5 as the default model for new setups.
...
Confirm that `model_provider = "capriole_ai"` is set and that `model` is one of the supported Capriole AI OpenAI model IDs.
