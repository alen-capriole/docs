...
`POST /v1/responses` acepta `openai-latest`, `openai/gpt-6-astra`, `openai/gpt-5.6-terra`, `openai/gpt-5.6-luna` y `openai/gpt-5.5`. Usa `openai-latest` para que Capriole AI elija nuestro modelo insignia recomendado de OpenAI Responses.

También puedes enviar ID nativos de OpenAI sin el prefijo `openai/`, como `gpt-6-astra`. Los ID nativos y los que llevan prefijo se resuelven a la misma entrada de modelo para el enrutamiento, los precios y la cuota.
