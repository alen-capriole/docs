...
`POST /v1/responses` acepta `openai-latest`, `openai/gpt-6-astra`, `openai/gpt-5.6-terra`, `openai/gpt-5.6-luna`, `openai/gpt-5.5` y `openai/gpt-5.4-mini`. Usa `openai-latest` para que Capriole AI elija nuestro modelo insignia recomendado de OpenAI Responses.
