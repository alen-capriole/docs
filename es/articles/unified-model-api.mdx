...
Las suites enfocadas de rutas públicas y conversión de archivos completaron **68 pruebas automatizadas** contra respuestas de upstream controladas, no llamadas en vivo de producción. Ejecuciones locales separadas de upstream y de agentes de programación comprueban el comportamiento que un endpoint simulado no puede demostrar.
