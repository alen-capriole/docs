...
Kilo Code 7.3.16：`anthropic/claude-fable-5-1`、`google/gemini-3.8-flash` 和 `zai/glm-5.3-flash` 已通过本地文件读取工具和最终答案检查。 `claude-latest` 解析到 Fable 5.1。原有具体模型 ID 继续可用。

Gemini 3.8 Flash 的检查使用 `"tool_call": true`；下方 Gemini 3.5 Flash 的设置保持 `"tool_call": false`。
