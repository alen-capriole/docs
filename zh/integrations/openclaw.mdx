...
OpenClaw 可以通过 Capriole AI 使用 OpenAI latest、GPT-6 Astra, GPT 5.6 Thinking、GPT 5.6、GPT 5.5、Fable 5.1、Fable 5、Opus 5、Grok 4.5、Gemini 3.8 Flash、GLM 5.3 Flash、GLM 5.2、Kimi K3、Claude latest、Opus 4.8、Opus 4.7、Opus 4.6 和 Sonnet 4.6。Fable 5 和 Opus 5 可以使用 Chat Completions 兼容提供商，也可以使用 Anthropic Messages 提供商。
